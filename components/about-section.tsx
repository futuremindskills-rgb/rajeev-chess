...
export function AboutSection() {
  ...
  const process = [
    "Open Website",
    "Visit rajeevinternationalchess.com",
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="animate-slide-up">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 text-balance">
              "Rajeev International Chess Club is the place for professional chess training"
            </h2>

            <div className="space-y-4 mb-8">
              <div>
                <h3 className="font-semibold text-foreground mb-2">Rajeev International Chess Club</h3>
                <p className="text-muted-foreground">www.rajeevinternationalchess.com</p>
              </div>
