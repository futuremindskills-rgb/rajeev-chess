    ...
    <section className="py-18 bg-white font-sans">
      ...
      <div className="max-w-[90rem] mx-auto px-4 md:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {otherPosts.map((post) => (
            <a href={`/blogs/${post.id}`} key={post.id} className="group flex flex-col h-full bg-white rounded-[2.5rem] border border-slate-100 overflow-hidden hover:shadow-[0_40px_80px_rgba(76,29,149,0.08)] transition-all duration-500">
